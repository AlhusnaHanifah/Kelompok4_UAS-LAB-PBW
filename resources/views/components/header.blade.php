        ...
        <nav class="flex justify-between items-center w-[92%]  mx-auto p-4">
            ...
            <div
                ...
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8">
                    <li>
                        <a class="text-lg font-semibold text-brown-800 hover:text-blue-300" href="#">My Talk</a>
                    </li>
                    <li>
                        <a class="text-lg font-semibold text-brown-800 hover:text-blue-300" href="#">Our Talk</a>
                    </li>
                </ul>
            </div>
